		...
		<?php
			if(!strcmp($_SESSION['user_role'], 'administrator')||!strcmp($_SESSION['user_role'], 'moderator'))
			{
				...
				<div class='content'>
					<div class='opt'>
						<ul>
							<li><a href='insert_users.php'>Добавить пользователя</a></li>
							<li><a href='edit_users.php'>Изменить пользователя</a></li>";
							if(!strcmp($_SESSION['user_role'], 'administrator'))
							{
								echo "<li><a href='delete_users.php'>Удалить пользователя</a></li>";
							}
						echo "
						</ul>
					</div>
